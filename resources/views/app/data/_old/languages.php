<form method="post" action="/data/main/filterLanguagesAction">
		...
		<div class="list-group">
			...
			<div class="list-group-item">
				...
				<div class="form-group">
					...
					</label> <a href="/data/main/editlanguage/{languageId}" class="btn btn-default btn-sm" target="_blank" >editar</a>
				</div>
				{/allLanguages}
			</div>
		</div>
