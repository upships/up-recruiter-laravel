...
<form method="post" action="/jobs" role="form" >
  <div class="row">
    <div class="col-lg-12">
...
<div class="row">
        ...
        <div class="list-group m-b-10">
            ...
            <div class="list-group-item">
                ...
                <div class="panel panel-default">
                 ...
                 <!-- Requisitos -->
                <div class="panel panel-default">
                    <div class="panel-heading" role="tab" id="jobRequirementsHeading">
                      <h4 class="panel-title">
                        <a role="button" data-toggle="collapse"  href="#jobRequirementsArea" aria-expanded="false" aria-controls="collapseOne">
                          <i class='fa fa-angle-down'></i> Requisitos
                        </a>
                      </h4>
                    </div>
                    <div id="jobRequirementsArea" class="panel-collapse collapse" role="tabpanel" aria-labelledby="jobRequirementsHeading">
    ...
    <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12">
        ...
        <div class="list-group m-b-10">
            <div class="list-group-item">
                <h4 class="list-group-item-heading"><span class='fa fa-linkedin-square float-right'></span> <span class='float-right fa fa-facebook-square'></span> Texto das redes sociais</h4>
            </div>
            <div class="list-group-item">
                <div class="form-group" >
                            ...
                            {trainings}
                                <li>
                                    <label >
                                        ...
                                        {{$training->label}} - {{$training->description}}                  
                                    </label>
                                </li>
                            {/trainings}
                        </ul>
...
{
    $('#requirementOne').clone().find('.jobRequirementItemInput').val('').end().appendTo('#jobRequirementsList');
    
    var tempId = Math.ceil(Math.random() * 100);

    console.log('Nova ID é ' + tempId);

    $('.jobRequirementsItem').last().attr('id', 'item' + tempId);
    $('.jobRequirementsItemRemover').last().attr('id',tempId);
});
